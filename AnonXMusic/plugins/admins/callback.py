        ...
        if command == "Skip":
            ...
            try:
                ...
                if not check:
                    ...
                    await CallbackQuery.message.reply_text(_["admin_10"].format(mention, CallbackQuery.message.chat.title))
                    try:
        ...
        if "live_" in queued:
            ...
            if videoid == "telegram":
                ...
                run = await CallbackQuery.message.reply_photo(
                    ...
                    caption=_["stream_1"].format(config.SUPPORT_GROUP, title, duration, user),
                    reply_markup=InlineKeyboardMarkup(button),
                )
                db[chat_id][0]["mystic"] = run
                db[chat_id][0]["markup"] = "tg"
