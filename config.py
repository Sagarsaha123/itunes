...
BOT_TOKEN = getenv("BOT_TOKEN", "7731546470:AAHmQ0oPhyABBxCIP_l5Doi0i7DCFflWVFM")
...
LOG_ID = int(getenv("LOG_ID", "-1002054900059"))
LOGGER_ID = int(getenv("LOGGER_ID", "-1002054900059"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Sagarsaha123/itunes",
)
