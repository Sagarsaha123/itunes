...
OWNER_ID = int(getenv("OWNER_ID", "5835406726"))
...
SONG_DOWNLOAD_DURATION = int(getenv("SONG_DOWNLOAD_DURATION", 1073741824))
SONG_DOWNLOAD_DURATION_LIMIT = int(getenv("SONG_DOWNLOAD_DURATION_LIMIT", 1073741824))
